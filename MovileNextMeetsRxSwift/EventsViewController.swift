...
class EventsViewController : UIViewController {
    ...
    private func createConstraints() {
        ...
        NSLayoutConstraint.activate([
            textFieldLabel.leftAnchor.constraint(equalTo: view.leftAnchor, constant: 8),
            textFieldLabel.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor, constant: 32),
            textFieldLabel.rightAnchor.constraint(equalTo: view.rightAnchor, constant: -8)
        ])
        ...
        // Button label
        NSLayoutConstraint.activate([
            buttonLabel.leftAnchor.constraint(equalTo: view.leftAnchor, constant: 8),
            buttonLabel.topAnchor.constraint(equalTo: textField.bottomAnchor, constant: 32),
            buttonLabel.rightAnchor.constraint(equalTo: view.rightAnchor, constant: -8)
        ])
        ...
        // Slider label
        NSLayoutConstraint.activate([
            sliderLabel.leftAnchor.constraint(equalTo: view.leftAnchor, constant: 8),
            sliderLabel.topAnchor.constraint(equalTo: button.bottomAnchor, constant: 32),
            sliderLabel.rightAnchor.constraint(equalTo: view.rightAnchor, constant: -8)
        ])
